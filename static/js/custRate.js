...
for (let i = 0; i < keys.length; i++) {
    ...
    if (label.innerHTML == "depart_date") {
        label.innerHTML = "Deaprture";
    } else if (label.innerHTML == "arrival_date") {
        label.innerHTML = "Arrival";
    } else if (label.innerHTML == "flight_num") {
        label.innerHTML = "Flight";
    } else if (label.innerHTML == "price") {
        label.innerHTML = "Price";
    } else if (label.innerHTML == "airline") {
        label.innerHTML = "Airline";
    }
